...
C_SRCS += \
../src/tasks/HEARTBEAT/task-heartbeat_lpc1769.c 

OBJS += \
./src/tasks/HEARTBEAT/task-heartbeat_lpc1769.o 

C_DEPS += \
./src/tasks/HEARTBEAT/task-heartbeat_lpc1769.d 


# Each subdirectory must supply rules for building sources it contributes
src/tasks/HEARTBEAT/%.o: ../src/tasks/HEARTBEAT/%.c
	@echo 'Building file: $<'
